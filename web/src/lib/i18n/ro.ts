export const ro = {
  ...
  // ─── site public ───  (Sprint 10 — Website Builder, /s/{slug})
  "site.nav.home": "Acasă",
  "site.nav.rooms": "Camere",
  "site.nav.book": "Rezervare",
  "site.not_found.title": "Acest site nu există",
  "site.not_found.subtitle": "Verifică adresa sau revino mai târziu.",
  "site.hero.cta_book": "Rezervă acum",
  "site.hero.cta_rooms": "Vezi camerele",
  "site.about.title": "Despre noi",
  "site.rooms_teaser.title": "Camerele noastre",
  "site.rooms_teaser.see_all": "Vezi toate camerele",
  "site.rooms_teaser.from": "de la",
  "site.services.title": "Facilități",
  "site.map.title": "Locație",
  "site.cta.title": "Rezervă sejurul tău",
  "site.rooms.title": "Toate camerele",
  "site.rooms.book_this": "Rezervă acest tip",
  ...
  // ─── site builder (PMS) ───
  "nav.website": "Website",
  "site_builder.forbidden": "Nu ai permisiunea de a gestiona website-ul acestei proprietăți.",

  // creare site
  "site_builder.create.title": "Creează site-ul proprietății",
  "site_builder.create.description": "Alege o adresă unică pentru site-ul public. O poți schimba oricând.",
  "site_builder.create.slug_label": "Adresă site",
  "site_builder.create.slug_hint": "Doar litere mici, cifre și cratimă, 3–63 caractere.",
  "site_builder.create.slug_invalid": "Adresă invalidă (litere mici, cifre, cratimă; 3–63 caractere).",
  "site_builder.create.slug_reserved": "Această adresă e rezervată.",
  "site_builder.create.slug_available": "Disponibilă",
  "site_builder.create.slug_taken": "Adresă deja folosită",
  "site_builder.create.preview": "Previzualizare",
  "site_builder.create.submit": "Creează site-ul",
  "site_builder.create.duplicate_slug": "Adresa a fost preluată între timp — alege alta.",
  "site_builder.create.success": "Site creat.",

  // header (stare + link public)
  "site_builder.header.enabled": "Site activ",
  "site_builder.header.disabled": "Site oprit",
  "site_builder.header.view_site": "Vezi site-ul",
  "site_builder.header.unpublished_warning": "Site-ul nu va fi accesibil public până nu publici proprietatea.",
  ...
  "site_builder.content.save": "Salvează conținutul",
  "site_builder.content.saved": "Conținut salvat.",
  "site_builder.content.hero.title": "Prezentare (Hero)",
  "site_builder.content.hero.title_label": "Titlu",
  "site_builder.content.hero.title_placeholder": "Numele proprietății (implicit)",
  "site_builder.content.hero.subtitle_label": "Subtitlu",
  "site_builder.content.about.title": "Despre",
  "site_builder.content.about.text_label": "Text",
  "site_builder.content.rooms_teaser.title": "Camere pe homepage",
  "site_builder.content.rooms_teaser.count_label": "Număr camere afișate",
  "site_builder.content.services.title": "Servicii",
  "site_builder.content.services.add": "Adaugă serviciu",
  "site_builder.content.services.icon_label": "Iconiță",
  "site_builder.content.services.title_label": "Titlu",
  "site_builder.content.services.description_label": "Descriere scurtă",
  "site_builder.content.services.empty": "Niciun serviciu adăugat.",
  "site_builder.content.services.move_up": "Mută mai sus",
  "site_builder.content.services.move_down": "Mută mai jos",
  "site_builder.content.services.remove": "Elimină",
  "site_builder.content.map.title": "Hartă",
  "site_builder.content.map.embed_label": "Link/Cod embed Google Maps",
  "site_builder.content.map.embed_hint": "Lipește URL-ul sau tot codul <iframe> generat de Google Maps (Share → Embed a map).",
  "site_builder.content.map.embed_invalid": "Nu recunoaștem acest link ca embed Google Maps.",
  "site_builder.content.map.preview": "Previzualizare",
  "site_builder.content.contact.title": "Contact",
  "site_builder.content.contact.phone_label": "Telefon",
  "site_builder.content.contact.email_label": "Email",
  "site_builder.content.pages.title": "Pagini",
  "site_builder.content.pages.rooms_label": "Pagina Camere",
  "site_builder.content.pages.book_label": "Pagina Rezervare",

  // iconițe servicii (set curat, ~12 relevante hotelier)
  "site_builder.icon.wifi": "Wi-Fi",
  "site_builder.icon.parking": "Parcare",
  "site_builder.icon.breakfast": "Mic dejun",
  "site_builder.icon.pool": "Piscină",
  "site_builder.icon.spa": "Spa",
  "site_builder.icon.restaurant": "Restaurant",
  "site_builder.icon.bar": "Bar",
  "site_builder.icon.ac": "Aer condiționat",
  "site_builder.icon.pets": "Pet friendly",
  "site_builder.icon.room_service": "Room service",
  "site_builder.icon.fitness": "Fitness",
  "site_builder.icon.beach": "Plajă",

  // fotografii
  "site_builder.photos.title": "Fotografii",
  "site_builder.photos.upload": "Încarcă fotografii",
  "site_builder.photos.uploading": "Se încarcă...",
  "site_builder.photos.empty": "Nicio fotografie încă. Încarcă prima poză a proprietății.",
  "site_builder.photos.general": "Poză generală",
  "site_builder.photos.tag_label": "Camera din poză",
  "site_builder.photos.alt_label": "Text alternativ",
  "site_builder.photos.delete_title": "Șterge fotografia",
  "site_builder.photos.delete_description": "Sigur vrei să ștergi această fotografie? Acțiunea nu poate fi anulată.",
  "site_builder.photos.too_large": "Fotografia depășește 5MB.",
  "site_builder.photos.invalid_type": "Format neacceptat (doar JPEG, PNG, WEBP).",
  "site_builder.photos.upload_error": "Fotografia nu a putut fi încărcată.",
  "site_builder.photos.updated": "Fotografie actualizată.",

  // audit
  "entity.property_site": "Website",
  "site_builder.event.created": "Website creat",
  "site_builder.event.updated": "Website actualizat",
  "site_builder.event.archived": "Website oprit",
  "site_builder.event.restored": "Website activat",
  "site_builder.event.deleted": "Website șters",
  "site_builder.field.slug": "Adresă",
  "site_builder.field.theme": "Temă",
  "site_builder.field.is_enabled": "Activ",
  "site_builder.field.contact_phone": "Telefon",
  "site_builder.field.contact_email": "Email",
  "site_builder.field.map_embed_url": "Hartă",
} as const
